...
class WalletViewCaptain extends StatefulWidget {
  const WalletViewCaptain({super.key});

  @override
  State<WalletViewCaptain> createState() => _WalletViewCaptainState();
}

class _WalletViewCaptainState extends State<WalletViewCaptain> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(title: "Wallet captain"),
      body: ListView(
              ...
              children: [
                Expanded(
                  child: MyElevatedButton(
                    ...
                    title: 'Send To Bank',
                    onPressed: () async {
                      await Navigator.pushNamed(context, Routes.sendToBankCaptain);
                ...
                Expanded(
                  child: MyElevatedButton(
                    ...
                    textStyle: primarySemiBold18,
                    onPressed: () async {
                      await Navigator.pushNamed(context, Routes.addMoneyCaptain);
                      _fetchWalletData(); // Refresh on return
                    },
                  ),
                ),
  ...
  Widget _buildTransactionList() {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore
          .collection('captain_wallet_transactions')
