...
class GoogleMapPlacePicker extends StatelessWidget {
  ...
  Widget _buildGoogleMapInner(PlaceProvider provider, MapType mapType) {
    ...
    return GoogleMap(
      ...
      circles: pickArea != null && pickArea!.radius > 0 ? <Circle>{pickArea!} : <Circle>{},
  ...
  //           data.item3 == true ||
  //           data.item4 == PinState.dragging && hidePlaceDetailsWhenDraggingPin!) {
  //         return Container();
  //       } else {
  ...
  //           pickArea!.radius;
  //   WidgetStateColor buttonColor =
  //       WidgetStateColor.resolveWith((states) => canBePicked ? Colors.lightGreen : Colors.red);
  //   return Container(
  ...
  //                           }
  //                         },
  //                         child: Icon(canBePicked ? Icons.check_sharp : Icons.app_blocking_sharp,
  //                             color: buttonColor)),
  //                   ),
  //                 ),
  //               )
  //             : SizedBox.fromSize(
  //                 size:
  //                     Size(MediaQuery.of(context).size.width * 0.8, 56), // button width and height
  //                 child: ClipRRect(
